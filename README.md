...
- **RPX_VERSION**： ![Release Version](https://img.shields.io/github/v/release/shmilx/XRePlugin.svg)
...
buildscript {
    ...
    dependencies {
        ...
        classpath "com.github.shmilx.XRePlugin:replugin-host-gradle:${RPX_VERSION}"
    }
}
```
...
dependencies {
    ...
    implementation "com.github.shmilx.XRePlugin:replugin-host-library:${RPX_VERSION}"
...
buildscript {
    ...
    dependencies {
        classpath 'com.android.tools.build:gradle:2.3.3' // AndroidX 工程需升级到 3.2.0 及以上
        classpath "com.github.shmilx.XRePlugin:replugin-plugin-gradle:${RPX_VERSION}"
    }
}
```
...
dependencies {
    ...
    implementation "com.github.shmilx.XRePlugin:replugin-plugin-library:${RPX_VERSION}"
}
